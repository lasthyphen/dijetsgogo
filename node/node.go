...
import (
	...
	dijethh "github.com/lasthyphen/dijethh/plugin/evm"

	"github.com/lasthyphen/dijetsgogo/api/admin"
	"github.com/lasthyphen/dijetsgogo/api/auth"
	"github.com/lasthyphen/dijetsgogo/api/health"
	"github.com/lasthyphen/dijetsgogo/api/info"
	...
	"github.com/lasthyphen/dijetsgogo/chains"
	...
	"github.com/lasthyphen/dijetsgogo/genesis"
	"github.com/lasthyphen/dijetsgogo/ids"
	"github.com/lasthyphen/dijetsgogo/indexer"
	"github.com/lasthyphen/dijetsgogo/ipcs"
	"github.com/lasthyphen/dijetsgogo/message"
	"github.com/lasthyphen/dijetsgogo/network"
	"github.com/lasthyphen/dijetsgogo/network/throttling"
	...
	"github.com/lasthyphen/dijetsgogo/snow/uptime"
	...
	ipcsapi "github.com/lasthyphen/dijetsgogo/api/ipcs"
)
...
func (n *Node) initChainManager(djtxAssetID ids.ID) error {
	...
	errs.Add(
		...
		n.Config.VMManager.RegisterFactory(constants.EVMID, &dijethh.Factory{}),
