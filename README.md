...
```sh
git clone git@github.com:lasthyphen/dijetsgogo.git
cd avalanchego
```
...
Download the [latest build](https://github.com/lasthyphen/dijetsgogo/releases/latest) for your operating system and architecture.
