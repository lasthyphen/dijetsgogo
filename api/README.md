...
Protobuf files are hosted at [https://buf.build/lasthyphen/dijetsgogo](https://buf.build/lasthyphen/dijetsgogo) and can be used as dependencies in other projects.
